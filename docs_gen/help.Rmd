...
- **limit** _optional_ absolute limit of the output file in Megabytes. Effective only if the `accelerated_io_tools` (AIO) plugin is enabled. If not sepcified, the default value of `aio_save` is used.
