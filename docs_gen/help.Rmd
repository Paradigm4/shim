...
<tr><td>METHOD <td>GET
<tr><td>PARAMETERS <td>
- **admin** _optional_ 0 or 1: if set to 1, open a priority session. This is identical to the `--admin` flag for the `iquery` client (see SciDB Documentation for details). The default value is 0.
